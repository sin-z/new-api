...
| --- | --- | --- | --- | --- | --- |
| 2026-07-09 | XRToken 视频任务查询协议适配 | `completed` | `docs/plans/2026-07-09_XRToken视频任务查询协议适配.md` | `docs/plans/2026-07-09_XRToken视频任务查询协议适配.md` | 将 XRTokenArkVideo 任务查询切到 `/v1/videos/generations/{task_id}`，并把上游 usage 与 Seedance native 字段映射到现有 public task 查询响应。 |
