...
const (
	...
	ChannelTypeXRTokenArkVideo       = 101
	ChannelTypeServiceInferenceVideo = 102
	ChannelTypeDummy                 = 103 // this one is only for count, do not add any channel after this
...
var ChannelBaseURLs = []string{
	...
	"",                                          //99
	"",                                          //100
	"https://api.xrtoken.net",                   //101
	"https://model.service-inference.ai",        //102
	"",                                          //103
}
...
var ChannelTypeNames = map[int]string{
	...
	ChannelTypeXRTokenArkVideo:       "XRTokenArkVideo",
	ChannelTypeServiceInferenceVideo: "service-inference.ai",
}
